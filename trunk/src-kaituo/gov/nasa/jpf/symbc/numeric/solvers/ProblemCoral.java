...
//	private static final long timeout = -1; //Config.timeout; // 1s default
	...
	protected static final ProblemCoral _pbcontext = new ProblemCoral();

	public ProblemCoral() {
		this(SolverKind.valueOf("PSO_OPT4J"));
	}
	...
	public static ProblemCoral get() {
	    return _pbcontext;
	  }
	 ...
	 */
	//gov.nasa.jpf.Config conf
	public void configure() {
		long seed = 464655L;
		int nIterations = 600;
		SolverKind kind = SolverKind.valueOf("PSO_OPT4J");
		boolean optimize = true;
		String intervalSolver = "none";
		String intervalSolverPath = "none";
