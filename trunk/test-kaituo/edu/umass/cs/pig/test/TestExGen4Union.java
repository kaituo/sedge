...
public class TestExGen4Union {
	...
	public static void oneTimeSetup() throws Exception {
		...
		F = "'" + "/home/kaituo/code/pig3/trunk/SDSSRandomData/EmptyFileFolder/part-m-00000" + "'";
	}
	...
	public void testFilterUnion() throws Exception {
		PigServer pigServer = new PigServer(pigContext);
		pigServer.registerQuery("A = load " + F.toString()
				+ " as (x:int, y:int);");
	...
	@Test
	public void testFilterUnion2() throws Exception {
		PigServer pigServer = new PigServer(pigContext);
		...
		pigServer.registerQuery("C = FILTER A by x < 3;");
		pigServer.registerQuery("D = UNION B, C;");
		pigServer.registerQuery("E = FILTER D by x > 10;");
