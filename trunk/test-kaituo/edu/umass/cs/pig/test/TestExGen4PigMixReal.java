...
//  page_views, , power_users
	static String pScalability, pData12, pData14, pData17;
...
//		widerowX = "'" + fileWiderowX.getPath() + "'";
		...
		data12X = "/home/kaituo/code/pig3/trunk/pigmixExtData/data12";
		users_sortedX = "/home/kaituo/code/pig3/trunk/pigmixExtData/data14";
		power_users_sampleX = "/home/kaituo/code/pig3/trunk/pigmixExtData/power_users_sample";
		widegroupbydataX = "/home/kaituo/code/pig3/trunk/pigmixExtData/widegroupbydata";
...
//		writeData12(page_viewsX, data12X, pData12);
//		writeData14(usersX, users_sortedX, pData14);
//		writeData17(page_viewsX, widegroupbydataX, pData17);

		System.out.println("widerowX : " + widerowX + "\n" + "page_viewsX : " + page_viewsX + "\n" + "power_usersX : " + power_usersX + "\n" + "usersX: " + usersX + "\n" + "data12X: " + data12X + "\n" + "power_users_sampleX: " + power_users_sampleX + "\n" + "widegroupbydataX: " + widegroupbydataX + "\n"); 
...
//	}
	...
	private static void writeData12(String dataOrig, String dataOut,
			String PIG_FILE) {
		try {
			PrintWriter w = new PrintWriter(new FileWriter(PIG_FILE));
	...
	private static void writeData14(String dataOrig, String dataOut,
			String PIG_FILE) {
		try {
			PrintWriter w = new PrintWriter(new FileWriter(PIG_FILE));
			w.println("register /home/kaituo/code/pigmix/pigperf.jar;");
	...
	private static void writeData17(String dataOrig, String dataOut,
			String PIG_FILE) {
		try {
			PrintWriter w = new PrintWriter(new FileWriter(PIG_FILE));
			w.println("register /home/kaituo/code/pigmix/pigperf.jar;");
...
//				+ "' using org.apache.pig.test.udf.storefunc.PigPerformanceLoader() as (user: chararray, action:int, timespent:int, query_term:chararray, ip_addr:long, timestamp:long,estimated_revenue:double, page_info:map[], page_links:bag{t:(p:map[])});");
//		pigServer.registerQuery("B = foreach A generate user, estimated_revenue;");
//	    pigServer.registerQuery("alpha = load '" + power_users_sampleX.toString() + "' using PigStorage('\u0001') as (name: chararray, phone: chararray, address: chararray, city: chararray, state: chararray, zip: int);");
...
//	  PigServer pigserver = new PigServer(pigContext);
//
//      String query = "A = load '" + widegroupbydataX
