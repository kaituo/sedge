...
public class TestExGen4FilterConditionNum22 {
...
//		filePhotoObj.deleteOnExit();
	...
	public void testFilter22() throws Exception {
		...
		pigServer.registerQuery("G = filter F by petroMag_g2 >= 16.0 and petroMag_g2 <= 21.0 and modelMag_u1 > -9999.0 and modelMag_g1 > -9999.0 and modelMag_r1 > -9999.0 and modelMag_i1 > -9999.0 and modelMag_z1 > -9999.0 and modelMag_u2 > -9999.0 and modelMag_g2 > -9999.0;");
