 ...
 *
 */
public class ProjectExpression extends ColumnExpression implements Serializable {
    
    /**
	 * 
	 */
	private static final long serialVersionUID = 5055164660367747006L;
    ...
    *//**
	...
	protected SWIGTYPE_p__Z3_ast mallocInZ3() {
	    ...
	    SWIGTYPE_p__Z3_symbol s = z3.mk_string_symbol(name);
		...
		try {
			...
			case DataType.INTEGER:
	            return z3.mk_const(s, BitVector32Sort.getInstance().getZ3Sort());
	        case DataType.LONG:
	            return z3.mk_const(s, BitVector64Sort.getInstance().getZ3Sort());
	        case DataType.FLOAT:
	            return z3.mk_const(s, Fp32Sort.getInstance().getZ3Sort());
	        case DataType.DOUBLE:
	            return z3.mk_const(s, Fp64Sort.getInstance().getZ3Sort());
	        default:
	            return null;
			}
