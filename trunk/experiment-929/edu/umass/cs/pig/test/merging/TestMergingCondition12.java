...
public class TestMergingCondition12 {
...
//		GalaxyPair2 = "'" + "/home/kaituo/code/pig3/trunk/SDSSRealData/GalaxyPair2" + "'";
	...
	public void testFilter12() throws Exception {
		...
		Map<Operator, DataBag> derivedData = pigServer.getExamples2("LG1");
	...
	public void testFilter15() throws Exception {
		...
		Map<Operator, DataBag> derivedData = pigServer.getExamples2("MG1");
		Map<Operator, DataBag> derivedData2 = pigServer.getExamples2("BG2");
