...
public class TestMergingConditionC1 {
...
//		GalaxyPair2 = "'" + "/home/kaituo/code/pig3/trunk/SDSSRealData/GalaxyPair2" + "'";
	...
	public void testFilter2() throws Exception {
		...
		Map<Operator, DataBag> derivedData = pigServer.getExamples("BG1");
	...
	public void testFilter3() throws Exception {
		...
		Map<Operator, DataBag> derivedData = pigServer.getExamples("CG1");
	...
	public void testFilter4() throws Exception {
		...
		Map<Operator, DataBag> derivedData = pigServer.getExamples("DG1");
	...
	public void testFilter5() throws Exception {
		...
		Map<Operator, DataBag> derivedData = pigServer.getExamples("EG1");
	...
	public void testFilter6() throws Exception {
		...
		Map<Operator, DataBag> derivedData = pigServer.getExamples("FG1");
	...
	public void testFilter7() throws Exception {
		...
		Map<Operator, DataBag> derivedData = pigServer.getExamples("GG1");
	...
	public void testFilter8() throws Exception {
		...
		Map<Operator, DataBag> derivedData = pigServer.getExamples("HG1");
	...
	public void testFilter9() throws Exception {
		...
		Map<Operator, DataBag> derivedData = pigServer.getExamples("IG1");
	...
	public void testFilter10() throws Exception {
		...
		Map<Operator, DataBag> derivedData = pigServer.getExamples("JG1");
	...
	public void testFilter11() throws Exception {
		...
		Map<Operator, DataBag> derivedData = pigServer.getExamples("KG1");
