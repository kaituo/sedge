...
//		filePhotoObj.deleteOnExit();
	...
	public void testFilter18() throws Exception {
		...
		Map<Operator, DataBag> derivedData = pigServer.getExamples2("MG1");
		Map<Operator, DataBag> derivedData2 = pigServer.getExamples2("EG2");
	...
	public void testFilter19() throws Exception {
		...
		Map<Operator, DataBag> derivedData = pigServer.getExamples2("MG1");
		Map<Operator, DataBag> derivedData2 = pigServer.getExamples2("FG2");
	...
	public void testFilter20() throws Exception {
		...
		Map<Operator, DataBag> derivedData = pigServer.getExamples2("MG1");
		Map<Operator, DataBag> derivedData2 = pigServer.getExamples2("GG2");
	...
	public void testFilter21() throws Exception {
		...
		Map<Operator, DataBag> derivedData = pigServer.getExamples2("MG1");
		Map<Operator, DataBag> derivedData2 = pigServer.getExamples2("HG2");
	...
	public void testFilter22() throws Exception {
		...
		Map<Operator, DataBag> derivedData = pigServer.getExamples2("MG1");
		Map<Operator, DataBag> derivedData2 = pigServer.getExamples2("IG2");
	...
	public void testFilter23() throws Exception {
		...
		Map<Operator, DataBag> derivedData = pigServer.getExamples2("MG1");
		Map<Operator, DataBag> derivedData2 = pigServer.getExamples2("JG2");
	...
	public void testFilter24() throws Exception {
		...
		Map<Operator, DataBag> derivedData = pigServer.getExamples2("MG1");
		Map<Operator, DataBag> derivedData2 = pigServer.getExamples2("KG2");
