...
public class TestMergingConditionC29 {
...
//		filePhotoObj.deleteOnExit();
		 ...
		 */
		GalaxyPair3 = "'" + "/home/kaituo/code/pig3/trunk/SDSSRandomData/30/MergingCondition/GalaxyPair2" + "'";
		GalaxyPair4 = "'" + "/home/kaituo/code/pig3/trunk/SDSSRandomData/30/MergingCondition/GalaxyPair3" + "'";
		neighbors = "'" + "/home/kaituo/code/pig3/trunk/SDSSRandomData/30/MergingCondition/neighbors1" + "'";
	}
	 ...
	 */
	@Test
	public void testFilter30() throws Exception {
		System.out.println("testFilter30");
		...
		Map<Operator, DataBag> derivedData = pigServer.getExamples("F");
