...
public class TestMergingConditionC33 {
...
//		filePhotoObj.deleteOnExit();
		 ...
		 */
		GalaxyPair3 = "'" + "/home/kaituo/code/pig3/trunk/SDSSRandomData/30/MergingCondition/GalaxyPair0" + "'";
		GalaxyPair4 = "'" + "/home/kaituo/code/pig3/trunk/SDSSRandomData/30/MergingCondition/GalaxyPair1" + "'";
		neighbors = "'" + "/home/kaituo/code/pig3/trunk/SDSSRandomData/30/MergingCondition/neighbors0" + "'";
	}
	...
	public void testFilter34() throws Exception {
		...
		Map<Operator, DataBag> derivedData = pigServer.getExamples("J");
