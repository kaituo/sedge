...
public class TestMergingConditionC12 {
...
//		GalaxyPair2 = "'" + "/home/kaituo/code/pig3/trunk/SDSSRealData/GalaxyPair2" + "'";
	...
	public void testFilter12() throws Exception {
		...
		Map<Operator, DataBag> derivedData = pigServer.getExamples("LG1");
	...
	public void testFilter15() throws Exception {
		...
		Map<Operator, DataBag> derivedData = pigServer.getExamples("MG1");
		Map<Operator, DataBag> derivedData2 = pigServer.getExamples("BG2");
