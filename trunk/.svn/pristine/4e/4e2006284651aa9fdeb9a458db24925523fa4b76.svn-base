...
/**
 * You should be careful though Z3's integer is mathematical integer which
 * can easily exceed the range of 32-bit int.  In that sense, using Z3_get_numeral_string
 * instead of Z3_get_numeral_int and parsing string to big integer is a better option.
 * @author kaituo
 *
 */
public class FakeLimit2 implements BackgroundAxiom {
...
//		bounds = new ArrayList<SWIGTYPE_p__Z3_ast>();
	...
	public boolean assertFakeLimitIntConversion(SWIGTYPE_p__Z3_ast z3Var) {
		try {
			...
			assertMinHelp3 = z3.mk_bvsub(z3Var, z3Min2.getZ3ast());
			SWIGTYPE_p__Z3_ast c2 = z3.mk_bvsub_no_overflow(z3Var, z3Min2.getZ3ast());
			SWIGTYPE_p__Z3_ast c3 = z3.mk_bvsub_no_underflow(z3Var, z3Min2.getZ3ast());
	...
	public boolean assertFakeLimitInt(SWIGTYPE_p__Z3_ast z3Var) {
		try {
			...
			assertMinHelp = z3.mk_bvsub(z3Var, z3MinInt.getZ3ast());
			SWIGTYPE_p__Z3_ast c2 = z3.mk_bvsub_no_overflow(z3Var, z3MinInt.getZ3ast());
			SWIGTYPE_p__Z3_ast c3 = z3.mk_bvsub_no_underflow(z3Var, z3MinInt.getZ3ast());
	...
	public boolean assertFakeLimitLong(SWIGTYPE_p__Z3_ast z3Var) {
		try {
			...
			assertMinHelp2 = z3.mk_bvsub(z3Var, z3MinLong.getZ3ast());
			SWIGTYPE_p__Z3_ast c2 = z3.mk_bvsub_no_overflow(z3Var, z3MinLong.getZ3ast());
			SWIGTYPE_p__Z3_ast c3 = z3.mk_bvsub_no_underflow(z3Var, z3MinLong.getZ3ast());
