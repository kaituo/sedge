...
//		filePhotoObj.deleteOnExit();
	...
	public void testFilter18() throws Exception {
		...
		Map<Operator, DataBag> derivedData2 = pigServer.getExamples("EG2");
	...
	public void testFilter19() throws Exception {
		...
		Map<Operator, DataBag> derivedData = pigServer.getExamples("MG1");
		Map<Operator, DataBag> derivedData2 = pigServer.getExamples("FG2");
	...
	public void testFilter20() throws Exception {
		...
		Map<Operator, DataBag> derivedData = pigServer.getExamples("MG1");
		Map<Operator, DataBag> derivedData2 = pigServer.getExamples("GG2");
	...
	public void testFilter21() throws Exception {
		...
		Map<Operator, DataBag> derivedData = pigServer.getExamples("MG1");
		Map<Operator, DataBag> derivedData2 = pigServer.getExamples("HG2");
	...
	public void testFilter22() throws Exception {
		...
		Map<Operator, DataBag> derivedData = pigServer.getExamples("MG1");
		Map<Operator, DataBag> derivedData2 = pigServer.getExamples("IG2");
	...
	public void testFilter23() throws Exception {
		...
		Map<Operator, DataBag> derivedData = pigServer.getExamples("MG1");
		Map<Operator, DataBag> derivedData2 = pigServer.getExamples("JG2");
	...
	public void testFilter24() throws Exception {
		...
		Map<Operator, DataBag> derivedData = pigServer.getExamples("MG1");
		Map<Operator, DataBag> derivedData2 = pigServer.getExamples("KG2");
