...
public class TestMergingCondition30 {
...
//		filePhotoObj.deleteOnExit();
	...
	@Test
	public void testFilter3031() throws Exception {
		System.out.println("testFilter3031");
	...
	@Test
	public void testFilter32() throws Exception {
		System.out.println("testFilter32");
	...
	@Test
	public void testFilter33() throws Exception {
		System.out.println("testFilter33");
		...
		pigServer.registerQuery("F = filter E by objID1 < objID2;");//
		pigServer.registerQuery("H = filter F by modelMag_g1 - modelMag_g2 > 3.0 or modelMag_g1 - modelMag_g2 < -3.0;");
		pigServer.registerQuery("I = filter H by petroR50_r1 >= 0.25*petroR50_r2 and petroR50_r1 <= 4.0*petroR50_r2;");
