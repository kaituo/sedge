...
public class TestExGen4SDSSReal2 {
...
//		filePhotoObj.deleteOnExit();
		...
		PhotoObj = "'" + "/home/kaituo/code/pig3/trunk/SDSSRealData/basic.dat" + "'";
		Galaxy = "'" + "/home/kaituo/code/pig3/trunk/SDSSRealData/galaxies2Criteria.dat"  + "'";
