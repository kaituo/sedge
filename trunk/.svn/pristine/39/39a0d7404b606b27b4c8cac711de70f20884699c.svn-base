...
public class TestMergingConditionC27 {
...
//		filePhotoObj.deleteOnExit();
	...
	public void testFilter27() throws Exception {
		...
		Map<Operator, DataBag> derivedData3 = pigServer.getExamples("AN");
	...
	public void testFilter28() throws Exception {
		...
		Map<Operator, DataBag> derivedData = pigServer.getExamples("MG2");
		Map<Operator, DataBag> derivedData2 = pigServer.getExamples("D");
