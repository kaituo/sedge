 ...
 *
 */
public abstract class UnaryExpression extends LogicalExpression implements Serializable {
    
    /**
	 * 
	 */
	private static final long serialVersionUID = -5039822744239570605L;
