...
public class TestMergingConditionC25 {
...
//		filePhotoObj.deleteOnExit();
	...
	public void testFilter25() throws Exception {
		System.out.println("testFilter25");
		...
		pigServer.registerQuery("AG2 = filter G2 by petrorad_u2 > 0.0 and petrorad_g2 > 0.0 and petrorad_r2 > 0.0 and petrorad_i2 > 0.0 and petrorad_z2 > 0.0 and petroRadErr_g2 > 0.0 and petroMag_g2 >= 16.0 and  petroMag_g2 <= 21.0 and modelMag_u2 > -9999.0 and modelMag_g2 > -9999.0 and modelMag_r2 > -9999.0 and modelMag_i2 > -9999.0;");
	...
	public void testFilter26() throws Exception {
		System.out.println("testFilter26");
