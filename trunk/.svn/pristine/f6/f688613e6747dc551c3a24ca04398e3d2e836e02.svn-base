...
public class TestExGen4SDSSReal3 {
...
//		filePhotoObj.deleteOnExit();
		...
		PhotoObj = "'" + "/home/kaituo/code/pig3/trunk/SDSSRandomData/BasicFdr/basic1.dat" + "'";
		Galaxy = "'" + "/home/kaituo/code/pig3/trunk/SDSSRandomData/galaxies2CriteriaFdr/galaxies2Criteria0.dat"  + "'";
		SpecClass = "'" + "/home/kaituo/code/pig3/trunk/SDSSRealData/unclassifiedSpectra1.dat" + "'";
		SpecObj = "'" + "/home/kaituo/code/pig3/trunk/SDSSRealData/unclassifiedSpectra2.dat" + "'";
		Galaxy2 = "'" + "/home/kaituo/code/pig3/trunk/SDSSRealData/multipleCriteria.dat" + "'";
		Galaxy3 = "'" + "/home/kaituo/code/pig3/trunk/SDSSRealData/spatialUnitVectors.dat" + "'";
		PhotoPrimary = "'" + "/home/kaituo/code/pig3/trunk/SDSSRealData/CVs.dat" + "'";
		Galaxy4 = "'" + "/home/kaituo/code/pig3/trunk/SDSSRealData/lowzQSOs.dat" + "'";
		PhotoPrimary2 = "'" + "/home/kaituo/code/pig3/trunk/SDSSRealData/velocitiesErrors.dat" + "'";
		Galaxy5 = "'" + "/home/kaituo/code/pig3/trunk/SDSSRealData/between.dat" + "'";
		PhotoObj2 = "'" + "/home/kaituo/code/pig3/trunk/SDSSRealData/movingAsteroids" + "'";
