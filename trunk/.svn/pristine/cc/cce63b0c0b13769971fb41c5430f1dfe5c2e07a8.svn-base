...
public class TestMergingConditionC31 {
...
//		filePhotoObj.deleteOnExit();
		 ...
		 */
		GalaxyPair3 = "'" + "/home/kaituo/code/pig3/trunk/SDSSRandomData/1000/MergingCondition/GalaxyPair2" + "'";
		GalaxyPair4 = "'" + "/home/kaituo/code/pig3/trunk/SDSSRandomData/1000/MergingCondition/GalaxyPair3" + "'";
		neighbors = "'" + "/home/kaituo/code/pig3/trunk/SDSSRandomData/1000/MergingCondition/neighbors1" + "'";
	}
	
	@Test
	public void testFilter3132() throws Exception {
		System.out.println("testFilter3132");
