...
public class TestMergingCondition34 {
...
//		filePhotoObj.deleteOnExit();
	...
	public void testFilter34() throws Exception {
		...
		pigServer.registerQuery("I = filter H by petroR50_r1 >= 0.25*petroR50_r2 and petroR50_r1 <= 4.0*petroR50_r2 and petroR50_r2 >= 0.25*petroR50_r1;");
	...
	public void testFilter35() throws Exception {
		...
		pigServer.registerQuery("F = filter E by objID1 < objID2;");//
		pigServer.registerQuery("H = filter F by modelMag_g1 - modelMag_g2 > 3.0 or modelMag_g1 - modelMag_g2 < -3.0;");
		pigServer.registerQuery("I = filter H by petroR50_r1 >= 0.25*petroR50_r2 and petroR50_r1 <= 4.0*petroR50_r2 and petroR50_r2 >= 0.25*petroR50_r1 and petroR50_r2 <= 4.0*petroR50_r1;");
